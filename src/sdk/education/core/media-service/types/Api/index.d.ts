...
import { NodeRtcEngine, NodeRtcChannel, RtcStats, LocalVideoStats, LocalAudioStats, RemoteVideoStats, RemoteAudioStats, RemoteVideoTransportStats, RemoteAudioTransportStats, RemoteVideoState, RemoteVideoStateReason, RemoteAudioState, RemoteAudioStateReason, AgoraNetworkQuality, LastmileProbeResult, ClientRoleType, StreamType, ConnectionState, ConnectionChangeReason, MediaDeviceType, VIDEO_PROFILE_TYPE, TranscodingConfig, InjectStreamConfig, VoiceChangerPreset, AudioReverbPreset, LastmileProbeConfig, Priority, CameraCapturerConfiguration, ScreenSymbol, CaptureRect, CaptureParam, VideoContentHint, VideoEncoderConfiguration, UserInfo, Metadata } from './native_type';
...
export declare class AgoraRtcEngine extends EventEmitter implements IAgoraRtcEngine {
 ...
 */
export declare interface IAgoraRtcEngine {
    [x: string]: any;
     ...
     * method.
     */
    destroyRender(key: 'local' | 'videosource' | number, channelId: string | undefined, onFailure?: (err: Error) => void): void;
    /**
...
declare interface AgoraRtcEngine {
    ...
    on(evt: 'audioVolumeIndication', cb: (uid: number, volume: number, vad: number, channelId: string, speakerNumber: number, totalVolume: number) => void): this;
     ...
     * {@link joinChannel} method until the SDK triggers this callback.
     */
    on(evt: 'firstRemoteVideoDecoded', cb: (uid: number, width: number, height: number, elapsed: number) => void): this;
     ...
     * {@link joinChannel} method until the SDK triggers this callback.
     */
    on(evt: 'remoteVideoStateChanged', cb: (uid: number, state: RemoteVideoState, reason: RemoteVideoStateReason, elapsed: number) => void): this;
     ...
     */
    on(evt: 'localUserRegistered', cb: (uid: number, userAccount: string) => void): this;
     ...
     */
    on(evt: 'userInfoUpdated', cb: (uid: number, userInfo: UserInfo) => void): this;
    /**
     ...
     */
    on(evt: 'localVideoStateChanged', cb: (localVideoState: number, error: number) => void): this;
    /**
     ...
     */
    on(evt: 'localAudioStateChanged', cb: (state: number, error: number) => void): this;
    /**
     ...
     * {@link joinChannel} method until the SDK triggers this callback.
     */
    on(evt: 'remoteAudioStateChanged', cb: (uid: number, state: RemoteAudioState, reason: RemoteAudioStateReason, elapsed: number) => void): this;
    /**
     ...
     */
    on(evt: 'channelMediaRelayState', cb: (state: ChannelMediaRelayState, code: ChannelMediaRelayError) => void): this;
    /**
     * Reports events during the media stream relay.
     *
     * - event: The event code. See {@link ChannelMediaRelayEvent}.
     */
    on(evt: 'channelMediaRelayEvent', cb: (event: ChannelMediaRelayEvent) => void): this;
    on(evt: 'audioPublishStateChange', cb: (channel: string, oldstate: number, newstate: number, elapsed: number) => void): this;
    on(evt: 'videoPublishStateChange', cb: (channel: string, oldstate: number, newstate: number, elapsed: number) => void): this;
    on(evt: 'audioSubscribeStateChange', cb: (channel: string, uid: number, oldstate: number, newstate: number, elapsed: number) => void): this;
    on(evt: 'videoSubscribeStateChange', cb: (channel: string, uid: number, oldstate: number, newstate: number, elapsed: number) => void): this;
    on(evt: 'receiveMetadata', cb: (metadata: Metadata) => void): this;
    on(evt: 'sendMetadataSuccess', cb: (metadata: Metadata) => void): this;
    on(evt: string, listener: Function): this;
}
declare class AgoraRtcChannel extends EventEmitter {
